		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#northwindappodatanorthwind-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"northwindappodatanorthwind-display": {
								"semanticObject": "northwindappodatanorthwind",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=northwind.app.odata.northwind",
									"url": sap.ui.require.toUrl("northwind/app/odata/northwind")
								}
							}
						}
					}
